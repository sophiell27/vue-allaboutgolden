    ...
    <div class="container">
        ...
        <div class="grid grid-cols-3 md:gap-x-6">
            <div class="col-span-3 mb-8 md:col-span-1 md:mb-0">
                <p class="mb-2">電郵： <span class="pb-px border-b border-b-secondary hover:border-0 hover:text-highlight"> <a href="mailto:gg@gmai.com" class="">gg@gmai.com</a></span></p>
            ...
            <div class="col-span-3 md:col-span-2 ">
               <div class="flex flex-col">
                <p class="mb-4">contact Form</p>
                <textarea cols="60" rows="10" class="mb-4 rounded-lg2 bg-transparent border-fog-300  focus:ring-secondary focus:border-primary" ></textarea>
                <button type="button"
                    class="py-2 px-12 bg-secondary rounded-lg2 text-white self-end">送出</button>
               </div>
            </div>
        </div>
