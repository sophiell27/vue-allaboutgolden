    ...
    <div class="">
      ...
      <ul class="grid grid-cols-2 gap-4 md:gap-6">
        ...
        <li
          ...
          <div>
            <h2 class="text-4.5 flex items-center justify-center mb-2 md:justify-start"><span
                class="pr-4 border-r-2 border-r-fog-200 font-bold">旺財媽媽</span> <span class="text-fog-400 text-h6 ml-4">藝術風
        ...
        <li
          ...
          <div>
            <h2 class="text-4.5 flex items-center justify-center mb-2 md:justify-start"><span
                class="pr-4 border-r-2 border-r-fog-200 font-bold">索菲亞</span> <span class="text-fog-400 text-h6 ml-4">華麗風格
                iPhone 14 pro 手機殼</span></h2>
            <p class="text-sm text-dark">
