...
<template>
  <section class="bg-[url('@/assets/images/layout/mainBanner-sm.svg')] bg-cover -mt-24  pb-[184px] mb-6 overflow-hidden md:-mt-[108px] md:bg-[url('@/assets/images/layout/mainBanner-lg.svg')]">
    <div class="container pt-48">
      ...
      <h3 class="text-lg font-bold mb-4 lg:text-h2 lg:mb-16">讓您輕鬆一次購足
        <br class="mb-1 md:hidden">高品質的<span class="px-1 ml-1 bg-secondary text-white inline-block">黃金獵犬精品</span>
        <br class="mb-2">
        享受免運優惠！
      </h3>
