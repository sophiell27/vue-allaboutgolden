  ...
  methods: {
    ...
    dogAnimate() {
      ...
      tl.set('.ball, .heroDoggie, .bannerLogo', { opacity: 0 })
        .from('.bannerLogo', {
          opacity: 'random(0.5, 1.5)', duration: 1,
        })
        .fromTo('.heroDoggie', {
          x: -200,
          rotation: 10,
...
<template>
  ...
  <div
    class="hero z-20 relative bg-hero-pattern-sm -mt-[72px] md:-mt-[108px] md:bg-banner-lg mb-6 bg-no-repeat bg-cover max-h-[100vh-36px]  md:static md:bg-contain md:mb-12  overflow-hidden"
